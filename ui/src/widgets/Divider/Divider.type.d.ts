export interface Divider {
  ...
  spec: {
    ...
    /**
     * The properties Divider renders. Where Divider wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
