export interface YamlViewer {
  ...
  spec: {
    /**
     * The properties YamlViewer renders. Where YamlViewer wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
