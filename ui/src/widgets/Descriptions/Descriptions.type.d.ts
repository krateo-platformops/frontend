export interface Descriptions {
  ...
  spec: {
    /**
     * The properties Descriptions renders. Where Descriptions wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
