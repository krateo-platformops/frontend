export interface Switch {
  ...
  spec: {
    /**
     * The properties Switch renders. Where Switch wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
