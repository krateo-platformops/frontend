export interface Markdown {
  ...
  spec: {
    /**
     * The properties Markdown renders. Where Markdown wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
