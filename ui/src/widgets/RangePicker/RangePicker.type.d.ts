export interface RangePicker {
  ...
  spec: {
    /**
     * The properties RangePicker renders. Where RangePicker wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
