export interface InputNumber {
  ...
  spec: {
    /**
     * The properties InputNumber renders. Where InputNumber wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
