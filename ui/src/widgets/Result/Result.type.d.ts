export interface Result {
  ...
  spec: {
    ...
    /**
     * The properties Result renders. Where Result wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
       * the result status
