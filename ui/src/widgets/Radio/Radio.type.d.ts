export interface Radio {
  ...
  spec: {
    /**
     * The properties Radio renders. Where Radio wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
