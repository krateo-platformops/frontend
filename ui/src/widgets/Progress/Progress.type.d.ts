export interface Progress {
  ...
  spec: {
    /**
     * The properties Progress renders. Where Progress wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
