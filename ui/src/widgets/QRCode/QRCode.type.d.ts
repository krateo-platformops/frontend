export interface QRCode {
  ...
  spec: {
    ...
    /**
     * The properties QRCode renders. Where QRCode wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
       * the encoded value
