export interface Checkbox {
  ...
  spec: {
    /**
     * The properties Checkbox renders. Where Checkbox wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
