export interface Slider {
  ...
  spec: {
    /**
     * The properties Slider renders. Where Slider wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
