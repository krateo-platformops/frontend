export interface Alert {
  ...
  spec: {
    ...
    /**
     * The properties Alert renders. Where Alert wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
       * the alert title
