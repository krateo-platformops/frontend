export interface Tag {
  ...
  spec: {
    ...
    /**
     * The properties Tag renders. Where Tag wraps an antd component these are antd's own prop names, so antd's documentation for that component describes them.
     */
    widgetData: {
      /**
       * the tag text
